...
public abstract class MockedPulsarServiceBaseTest {
    ...
    protected static final String CONFIG_CLUSTER_NAME = "test";
    ...
    protected int pulsarKeeperPort;
    ...
    protected void doInitConf() throws Exception {
        ...
        this.pulsarKeeperPort = PortManager.nextFreePort();
        Properties properties = this.conf.getProperties();
        properties.put("pulsarKeeperPort", pulsarKeeperPort);
    ...
    protected TenantInfoImpl createDefaultTenantInfo() throws PulsarAdminException {
        ...
        if (!admin.clusters().getClusters().contains(CONFIG_CLUSTER_NAME)) {
            admin.clusters().createCluster(CONFIG_CLUSTER_NAME, ClusterData.builder().build());
        }
        Set<String> allowedClusters = Sets.newHashSet();
        allowedClusters.add(CONFIG_CLUSTER_NAME);
